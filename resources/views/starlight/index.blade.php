                ...
                <div class="card-body">
                    ...
                    <?php 
                        if(!Auth::user()->isAdmin()){
                            echo "<col><col><col><col><col><col><col style='visibility:collapse;'><col><col><col><col><col><col style='visibility:collapse;'><col>";
                        }
                    ?>
                    <thead>
                        <tr >
                    ...
                    <tbody id="myTable">
                    <?php foreach ($starlights as $starlight){?>
                        ...
                        <tr>
                            ...
                            <td style="
                            <?php 
                                if($starlight->status == 'Pending'){echo 'background-color: #ff0000; color: white;';}
                                if($starlight->status == 'Done'){echo 'background-color: green; color: white;';}
                                if($starlight->status == 'Cancel'){echo 'background-color: black; color: white;';}
                            ?>">
                                {{ $starlight->status }}</td>
                            <td>{{ $starlight->payment_method }}</td>
                            <td>{{ $starlight->profit }}</td>
                            <td style="background-color: white"><a href="/pre_order_starlight/<?= $starlight->id?>" class="btn btn-primary ">Edit</a></td>
                        </tr>
                    <?php }?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="form-group">
                                <form  action="{{ route('starlight.store') }}" method="post" id="orderForm">
                                @csrf
