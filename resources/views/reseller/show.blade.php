    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-4"> 
                        <form  action="/diamond/{{ $resellerData->id }}" method="post" id="updateForm">
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control form-control-border border-width-2" name="name" id="Name"  value="{{ $resellerData->name }}" placeholder="e.g: John Doe">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-border border-width-2" name="ml_id" id="ml_id" value="{{ $resellerData->ml_id }}" placeholder="ex: 123456789(1234)">
                    ...
                    <div class="col-4">     
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-border border-width-2" name="ign" id="ign" value="{{ $resellerData->ign }}" placeholder="e.g: jOhnD0e#123">
                    ...
                    <div class="col-4"> 
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-border border-width-2" name="ref" id="ref" value="{{ $resellerData->ref }}" placeholder="ex: Filter Dupli">
                    ...
                    <div class="col-4"> 
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-border border-width-2" name="payment_method" id="payment_method" value="{{ $resellerData->payment_method }}" placeholder="ex: Drop Down">
                        ...
                        <div class="btn-group ml-2">
                            <select class="btn btn-default dropdown-toggle" name="status">
                                <div class="dropdown-menu">
                                    <?php 
                                        echo '<option class="dropdown-item" value="Done"'.(($resellerData->status == "Done") ? "selected" : ""). '>Done</option>';
                                        echo '<option class="dropdown-item" value="Pending"'.(($resellerData->status == "Pending") ? "selected" : ""). '>Pending</option>';
                                        echo '<option class="dropdown-item" value="Cancel"'.(($resellerData->status == "Cancel") ? "selected" : ""). '>Cancel</option>';
                                    ?>
                                </div>
                            </select>   
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <tbody id="myTable">
                    <tr>
                    @foreach($resellerHistories as $resellerHistory)
                        ...
                        <td style="
                        <?php 
                            if($resellerHistory->status == 'Pending'){echo 'background-color: #ff0000; color: white;';}
                            if($resellerHistory->status == 'Done'){echo 'background-color: green; color: white;';}
                            if($resellerHistory->status == 'Cancel'){echo 'background-color: black; color: white;';}
                        ?>">
                            {{ $resellerHistory->status }}</td>
                        <td>{{ $resellerHistory->payment_method }}</td>
