        ...
        <div class="row">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <tbody>
                    @foreach ($order_diamonds as $order_diamond)
                        <tr >
                        
                            <td>{{ $order_diamond->date }}</td>
                            <td>{{ $order_diamond->request_by }}</td>
                            <td>{{ $order_diamond->name }}</td>
                            <td>{{ $order_diamond->order_value }}</td>
                            <td>{{ $order_diamond->diamonds_value }}</td>
                            <td>{{ $order_diamond->coins_value }}</td>
                            <td>{{ $order_diamond->ml_id }}</td>
                            <td>{{ $order_diamond->ign }}</td>
                            <td>{{ $order_diamond->ref }}</td>
                            <td>{{ $order_diamond->status }}</td>
                            <td>{{ $order_diamond->payment_method }}</td>
                            <td>{{ $order_diamond->profit_value }}</td>
                        </tr>
